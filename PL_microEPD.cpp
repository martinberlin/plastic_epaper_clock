...
PL_microEPD::PL_microEPD(int8_t _cs, int8_t _rst, int8_t _busy) : Adafruit_GFX(EPD_WIDTH, EPD_HEIGHT) {
...
void PL_microEPD::begin(bool whiteErase) {
    ...
    switch (_EPDsize) {
        case 11:
            _width=148; _height=72; nextline= _width/4; _buffersize=_width*_height/4;
            width=72; height=148;
            ...
            Serial.print("1.1 detected\n");
            break;
        case 14:
            _width=180; _height=100; nextline= _width/4; _buffersize=_width*_height/4;
            width=100; height=180;
            writeRegister(EPD_PANELSETTING, 0x12, -1, -1, -1);      	
            writeRegister(EPD_WRITEPXRECTSET, 0, 0xB3, 0x3C, 0x9F);
            writeRegister(EPD_VCOMCONFIG, 0x00, 0x00, 0x24, 0x07);
            Serial.print("1.4 detected\n");
            break;
        case 21:
            _width=240; _height=146; nextline= _width/4; _buffersize=_width*_height/4;
            width=146; height=240;
